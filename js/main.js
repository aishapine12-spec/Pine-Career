...
(function(){
  ...
  function buildHeader(){
    ...
    host.innerHTML =
      '<div class="nav-bar">' +
        ...
        '</ul>' +
        '<div class="nav-cta">' +
          '<a href="contact.html" class="btn btn-gold btn-sm"> Book a Demo</a>' +
  ...
  /* ========================================================================
     TEMPORARILY DISABLE INTERNAL NAVIGATION
     
     IMPORTANT:
     - Keeps the existing UI/design.
     - Keeps Services dropdown opening.
     - Stops internal .html page navigation.
     - External links such as LinkedIn/Instagram continue working.
     - mailto links continue working.
     - YouTube external links continue working.
     ======================================================================== */

  function disableInternalNavigation(){
    ...
    document.addEventListener("click", function(e){
      ...
      if (isInternal){
        ...
        console.log(
          "Pine Careers: internal navigation temporarily disabled ->",
          href
        );
  ...
  function buildFooter(){
    ...
    var quickHTML = FOOTER_QUICK.map(function(l){
      return '<li><a href="' + l.href + '">' + l.label + '</a></li>';
    }).join("");

    var servicesHTML = FOOTER_SERVICES.map(function(l){
      return '<li><a href="' + l.href + '">' + l.label + '</a></li>';
    }).join("");
    ...
    host.innerHTML =
      ...
      '<div class="footer-main">' +
        ...
        '<div class="footer-brand">' +
          ...
          '<div class="footer-social">' +
            ...
            '<a href="mailto:info@pinecareers.com" aria-label="Email Pine Careers">' +
            ...
            '<a href="' + SOCIAL_LINKS.linkedin + '" target="_blank" rel="noopener" aria-label="Pine Careers on LinkedIn">' +
              '<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">' +
                '<path d="M6.94 5a2 2 0 1 1-4-.002 2 2 0 0 1 4 .002zM7 8.48H3V21h4zM13.5 8.48h-3.83V21h3.83v-6.57c0-3.66 4.75-3.96 4.75 0V21H22v-7.93c0-6.17-6.78-5.94-8.5-2.91z"/>' +
              '</svg>' +
            '</a>' +

            '<a href="' + SOCIAL_LINKS.instagram + '" target="_blank" rel="noopener" aria-label="Pine Careers on Instagram">' +
              '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">' +
        ...
        '<div class="footer-col contact"><h4>Get In Touch</h4><ul>' +
          ...
          '<li>' +
            ...
            '<a href="mailto:info@pinecareers.com">info@pinecareers.com</a>' +
          '</li>' +

          '<li>' +
            '<span class="label">Location</span>' +
            '<span>B-314, iThum Tower, Plot No. A-40, Sector-62, Noida, Gautam Buddha Nagar-201301, Uttar Pradesh</span>' +
          '</li>' +

          '<li>' +
            '<span class="label">Response Time</span>' +
            '<span>Within two business days</span>' +
          '</li>' +
      ...
      '<div class="footer-bottom">' +
        ...
        '<p>&copy; ' +
          ...
          ' Pine Careers. All rights reserved.' +
        '</p>' +
  ...
  function initTestimonials(){
    ...
    var track =
      document.querySelector(".t-track");

    if (!track) return;

    var slides =
      Array.prototype.slice.call(
        track.querySelectorAll(".t-slide")
      );

    var dotsHost =
      document.querySelector(".t-dots");
    ...
    if (dotsHost){
      ...
      dotsHost.innerHTML =
        slides.map(function(_, i){
          ...
          return '<button type="button" aria-label="Show testimonial ' +
            (i+1) +
            '"' +
            (i===0 ? ' class="active"' : '') +
            '></button>';
    ...
    var dots =
      dotsHost
        ? Array.prototype.slice.call(
            dotsHost.querySelectorAll("button")
          )
        : [];
    ...
    form.addEventListener(
      ...
      function(e){
        ...
        window.location.href =
          "mailto:info@pinecareers.com?subject=" +
          subject +
          "&body=" +
          body;
  ...
  document.addEventListener(
    ...
    function(){
      ...
      /*
       * TEMPORARILY DISABLE INTERNAL PAGE NAVIGATION
       *
